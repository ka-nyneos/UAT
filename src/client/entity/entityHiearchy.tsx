  ...
  useEffect(() => {
    const syncAndFetchHierarchy = async () => {
      ...
      try {
        ...
        setVisibility({
          approve: response.data.hierarchical.default.showApproveButton,
          reject: response.data.hierarchical.default.showRejectButton,
          edit: response.data.hierarchical.default.showEditButton,
        });
