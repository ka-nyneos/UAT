...
//   import "../../styles/theme.css"; // Adjust the path as necessary
...
//   interface TableProps<HedgingProposal> {
...
//     onUpdate?: (rowId: string, changes: Partial<HedgingProposal>) => Promise<boolean>;
//     className?: string;
//     setData?: (data : HedgingProposal[]) => void;
//   }

//   interface ExpandedRowProps<HedgingProposal> {
...
//   function ExpandedRow<HedgingProposal >({
//     row,
//     config,
//     onUpdate,
//     visibleColumnCount,
...
//     const getChangedFields = (original: HedgingProposal, edited: Partial<HedgingProposal>): Partial<HedgingProposal> => {
...
//         if (onUpdate) {
//           const success = await onUpdate(row.original.id, changedFields as HedgingProposal);
//           if (success) {
...
// // Render-safe version as string for display purposes
// // let displayValue: string | number | boolean = value ?? "—";

// // if (!isEditing && typeof value === "string" && key.toLowerCase().includes("date")) {
...
//                 className="border rounded px-2 py-1 text-sm bg-white shadow-sm"
//                 value={String(value || "")}
//                 onChange={(e) => handleChange(key as keyof HedgingProposal, e.target.value)}
//               />
//             )
//           ) : (
...
//   function NyneOSTable<HedgingProposal >({
//     data,
//     filter,
//     columns,
...
//             {/* <Button onClick={() => table.setColumnVisibility({})}>Approve</Button> */}
//             {/* <Button onClick={() => table.setColumnVisibility({})}>Reject</Button> */}
      ...
      <div className="flex items-center justify-end pt-4 gap-2">
        {approve && (
          <div className="flex items-center gap-2 min-w-[8rem]">
            <Button onClick={() => table.setColumnVisibility({})}>
              Approve
            </Button>
          </div>
        )}
